  ...
  return (
    <Dialog open={isOpen} onOpenChange={(open) => !open && onClose()}>
      <DialogContent className="max-w-[480px] max-h-[80vh] flex flex-col">
        <DialogHeader>
          <DialogTitle>Налаштування {operator}</DialogTitle>
          <DialogDescription>
            Якщо вам потрібно використовувати на тривалий та стабільний період,
            ви можете увійти до консолі Volcengine FaaS для оновлення.
          </DialogDescription>
        </DialogHeader>
        <div
        ...
        >
          ...
          <Steps step={1} classname="mt-[-40px]">
            Прочитайте віддалену документацію
          </Steps>
          ...
          <Steps step={2}>Віддалені налаштування</Steps>
          ...
          <Steps step={3}>Налаштування VLM</Steps>
          <VLMSettings
            ref={vlmSettingsRef}
